...
@section('title')
    @lang('sidebar.validation') - @lang('sidebar.family')
@endsection
@section('contentheader')
    @lang('sidebar.validation') - @lang('sidebar.family')
@endsection
@section('contentheaderlink')
    <a href="{{ route('admin.reports.localites') }}">  @lang('sidebar.validation') - @lang('sidebar.family') </a>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="data" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($localite_reports as $report)
                                <tr>
                                    <td>{{$report->wilaya}}</td>
                                    <td>{{$report->moughata}}</td>
                                    <td>{{$report->commune}}</td>
                                    <td>{{$report->localite}}</td>
                                    <td>{{$report->code_ansade}}</td>
                                    <td>{{$report->operation}}</td>
                                    <td>{{$report->projet}}</td>
                                    <td>{{$report->operateur}}</td>
                                    <td>{{$report->date_op}}</td>
                                </tr>
                            @endforeach
