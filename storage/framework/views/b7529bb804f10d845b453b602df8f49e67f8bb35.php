            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title"><?php echo e(__('Update')); ?> Evaluateur</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('evaluateurs.update', $evaluateur->id)); ?>" role="form"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lapto\OneDrive\Documents\laravel\anac\resources\views/admin/evaluateurs/edit.blade.php ENDPATH**/ ?>