<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::select('key', $options, $setting->key, ['class' => 'form-control' . ($errors->has('key') ? ' is-invalid' : ''), 'placeholder' => 'Select Key'])); ?>
...
<?php /**PATH C:\Users\lapto\OneDrive\Documents\laravel\anac\resources\views/admin/settings/form.blade.php ENDPATH**/ ?>