            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Formulaire -->
                        <form action="<?php echo e(route('examinateur.update', $examen)); ?>" method="POST"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="examinateur_id" value="<?php echo e($examen->examinateur_id); ?>">
                            <input type="hidden" name="demandeur_id" value="<?php echo e($examen->demandeur_id); ?>">
                            <div class="mb-3">
                                <label class="form-label">Date Examen</label>
                                <input type="date" name="date_examen" class="form-control" value="<?php echo e($examen->date_examen); ?>"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Validite</label>
                                <input type="number" name="validite" class="form-control" value="<?php echo e($examen->validite); ?>"
                                    required>
                            </div>
                            <div class="mb-3">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('examinateur.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lapto\OneDrive\Documents\laravel\anac\resources\views/examinateur/edit.blade.php ENDPATH**/ ?>