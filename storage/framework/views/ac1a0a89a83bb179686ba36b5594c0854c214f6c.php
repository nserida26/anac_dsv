                ...
                <div class="card shadow mb-4">
                    <div class="card-profile-image mt-4">
                        <div class="text-center">
                            ...
                            <img src="<?php echo e(asset('/uploads/' . $demandeur->photo)); ?>"
        ...
        <?php if(!isset($demandeur)): ?>
            <div class="col-lg-12 order-lg-1">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('user.profile.update')); ?>" autocomplete="off"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group focused">
                                            ...
                                            <select class="form-control" id="compagnie_id" name="compagnie_id">
                                                ...
                                                <?php $__currentLoopData = $compagnies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compagnie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($compagnie->id); ?>">
                                                        <?php echo e($compagnie->nom_entreprise); ?> <?php echo e($compagnie->adresse); ?>
...
<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(asset('assets/admin/plugins/jquery-validation/dist/jquery.validate.min.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php $__env->startPush('custom'); ?>
    <script>
        $(document).ready(function() {
            $("#uploadBtn").show();
            // Custom method to check image size (Max: 5MB)
            $.validator.addMethod("fileSize", function(value, element, param) {
                return element.files[0].size <= param;
            }, "File size must be under 5MB.");

            // Custom method to check image dimensions (413x531 pixels)
            $.validator.addMethod("imageDimensions", function(value, element, param) {
                if (element.files.length === 0) {
                    return true; // Ne pas valider si aucun fichier n'est sélectionné
                }
                ...
                img.onload = function() {
                    ...
                    console.log("Required width:", param[0]);
                    console.log("Required height:", param[1]);
                ...
                return deferred.then(() => true, () => false);
            }, "L'image doit être exactement de {0}x{1} pixels.");
            ...
            $("#imageUploadForm").validate({
                ...
                invalidHandler: function() {
                    // ❌ Hide "Upload" button if validation fails
                    //$("#uploadBtn").hide();
                    $("#error-message").css("color", "red");
                },
                submitHandler: function(form) {
                    // ✅ Show "Upload" button only when valid
                    $("#uploadBtn").show();
                    //alert("Image is valid and ready for upload!");
                    form.submit(); // Uncomment if you want normal form submission
                }
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lapto\OneDrive\Documents\laravel\anac\resources\views/user/profile.blade.php ENDPATH**/ ?>