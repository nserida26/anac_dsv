                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                <?php echo e(__('Evaluateur')); ?>

                            </span>

                            <div class="float-right">
                                <a href="<?php echo e(route('evaluateurs.create')); ?>" class="btn btn-primary btn-sm float-right"
                                    data-placement="left">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $evaluateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($evaluateur->np); ?></td>
                                            <td><?php echo e($evaluateur->user->email); ?></td>

                                            <td>
                                                <form action="<?php echo e(route('evaluateurs.destroy', $evaluateur->id)); ?>"
                                                    method="POST">
                                                    <a class="btn btn-sm btn-primary "
                                                        href="<?php echo e(route('evaluateurs.show', $evaluateur->id)); ?>"><i
                                                            class="fa fa-fw fa-eye"></i> <?php echo e(__('Show')); ?></a>
                                                    <a class="btn btn-sm btn-success"
                                                        href="<?php echo e(route('evaluateurs.edit', $evaluateur->id)); ?>"><i
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lapto\OneDrive\Documents\laravel\anac\resources\views/admin/evaluateurs/index.blade.php ENDPATH**/ ?>