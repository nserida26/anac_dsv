                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(route('examinateur.create', $demandeur)); ?>"
                                                    class="btn btn-info btn-sm"><?php echo app('translator')->get('trans.create'); ?></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(!$examen->valider_examinateur): ?>
                                                    ...
                                                    <form action="<?php echo e(route('examinateur.valider', $examen)); ?>"
                                                    ...
                                                    <form action="<?php echo e(route('examinateur.destroy', $examen)); ?>"
                                                        method="POST" class="d-inline">
                                                        <?php echo csrf_field(); ?>
